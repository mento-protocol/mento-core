...
import "contracts/v3/NFTMetadata/utils/Utils.sol";
import "contracts/v3/NFTMetadata/utils/FixedAssets.sol";
...
contract MetadataDeployment is Script /* , StdAssertions */ {
  ...
  function _loadFiles() internal {
    string memory root = string.concat(vm.projectRoot(), "/contracts/v3/assets/");
