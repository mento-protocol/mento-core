...
import { Math } from "openzeppelin-contracts-v4.9.5/contracts/utils/math/Math.sol";
import { Address } from "openzeppelin-contracts-v4.9.5/contracts/utils/Address.sol";
import { Strings } from "openzeppelin-contracts-v4.9.5/contracts/utils/Strings.sol";
import { LatestBatchData } from "contracts/v3/Types/LatestBatchData.sol";
import { LatestTroveData } from "contracts/v3/Types/LatestTroveData.sol";
import { IBorrowerOperations } from "contracts/v3/Interfaces/IBorrowerOperations.sol";
import { ISortedTroves } from "contracts/v3/Interfaces/ISortedTroves.sol";
import { ITroveManager } from "contracts/v3/Interfaces/ITroveManager.sol";
import { AddressesRegistry } from "contracts/v3/AddressesRegistry.sol";
import { AddRemoveManagers } from "contracts/v3/Dependencies/AddRemoveManagers.sol";
import { BorrowerOperations } from "contracts/v3/BorrowerOperations.sol";
import { TroveManager } from "contracts/v3/TroveManager.sol";
...
contract InvariantsTestHandler is Assertions, BaseHandler, BaseMultiCollateralTest {
    ...
    try
      _functionCaller.call(
        ...
        v.useZombie
          ...
          : _encodeActiveTroveAdjustment(v.prop, v.troveId, collChange, isCollInc, debtChange, isDebtInc, v.upfrontFee)
      )
    {
  ...
  function adjustTroveInterestRate(
    ...
    vm.prank(msg.sender);
    try
      v.c.borrowerOperations.adjustTroveInterestRate(v.troveId, newInterestRate, v.upperHint, v.lowerHint, v.upfrontFee)
    {
