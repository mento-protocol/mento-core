...
import "contracts/v3/Zappers/Modules/Exchanges/UniswapV3/IUniswapV3Pool.sol";
...
import "contracts/v3/Zappers/Modules/Exchanges/UniswapV3/IUniswapV3Factory.sol";
import "contracts/v3/Zappers/Modules/Exchanges/UniswapV3/IQuoterV2.sol";
...
import "contracts/v3/Zappers/Modules/Exchanges/HybridCurveUniV3ExchangeHelpers.sol";
import "contracts/v3/Zappers/Interfaces/IFlashLoanProvider.sol";
import "contracts/v3/Zappers/Modules/FlashLoans/Balancer/vault/IVault.sol";
...
contract ZapperLeverageMainnet is DevTestSetup {
  ...
  function closeTrove(IZapper _zapper, uint256 _troveId, ITroveManager _troveManager, IPriceFeed _priceFeed) internal {
    // This should be done in the frontend
    (uint256 flashLoanAmount, uint256 minExpectedCollateral) = _getCloseFlashLoanAmount(
      _troveId,
      _troveManager,
      _priceFeed
    );
  ...
  function testCannotCloseTroveIfFrontRunByRedemption() external {
    ...
    (uint256 flashLoanAmount, uint256 minExpectedCollateral) = _getCloseFlashLoanAmount(
      troveId,
      contractsArray[0].troveManager,
      contractsArray[0].priceFeed
    );
