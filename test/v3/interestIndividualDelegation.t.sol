...
import "contracts/v3/Dependencies/AddRemoveManagers.sol";
...
contract InterestIndividualDelegationTest is DevTestSetup {
  ...
  function testSetsDelegateProperly() public {
    ...
    IBorrowerOperations.InterestIndividualDelegate memory delegate = borrowerOperations.getInterestIndividualDelegateOf(
      troveId
    );
