...
contract troveNFTTest is DevTestSetup {
  ...
  function _writeUriFile(string[] memory _uris) public {
    string memory pathClean = string.concat("contracts/v3/assets/test_output/uris.html");
  ...
  function testTroveURIAttributes() public view {
    ...
    assertTrue(
      LibString.contains(decodedUri, '"description": "Liquity V2 is a collateralized debt platform. Users can lock up'),
