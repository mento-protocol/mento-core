...
contract MentoTokenTest is Test {
    ...
    address constant public VESTING_CONTRACT = address(111);
    address constant public AIRGRAB_CONTRACT = address(222);
    address constant public TREASURY_CONTRACT = address(333);
    address constant public EMISSION_CONTRACT = address(444);

    address constant public ALICE = address(9999);
    address constant public BOB = address(8888);

    uint256 constant public INITIAL_TOTAL_SUPPLY = 1_000_000_000 * 1e18;
    ...
    /// @notice Even though the burn function comes from OpenZeppelin's library, this test assures correct integration.
    ...
    /// @notice Even though the burnFrom function comes from OpenZeppelin's library, this test assures correct integration.
