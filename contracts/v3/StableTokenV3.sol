 ...
 */
contract StableTokenV3 is IStableTokenV3, ERC20PermitUpgradeable, OwnableUpgradeable {
  ...
  modifier onlyMinter() {
    ...
    require(
      sender == broker ||
        sender == validators ||
        sender == exchange ||
        borrowerOperationsAddresses[sender] ||
        activePoolAddresses[sender],
  ...
  modifier onlyBurner() {
    ...
    require(
      sender == broker ||
        sender == exchange ||
        sender == collateralRegistryAddress ||
        stabilityPoolAddresses[sender] ||
        borrowerOperationsAddresses[sender] ||
        troveManagerAddresses[sender],
  ...
  modifier onlyStabilityPool() {
    require(stabilityPoolAddresses[_msgSender()], "StableTokenV2: not allowed to call");
    _;
  }
  ...
  function setCollateralRegistry(address _collateralRegistry) external override onlyOwner {
    collateralRegistryAddress = _collateralRegistry;
  }
  ...
  function sendToPool(address _sender, address _poolAddress, uint256 _amount) external override onlyStabilityPool {
