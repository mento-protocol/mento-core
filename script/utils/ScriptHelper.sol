  ...
  function getNetworkProxies() internal pure returns (NetworkProxies memory proxies) {
    ...
    if (_chainId == NETWORK_BAKLAVA) {
      proxies = NetworkProxies({
        ...
        broker: 0xE9cc3fECC1823aB6fe6527d1Da84F62031B4693A,
        ...
        biPoolManager: 0x70626EA89c9e76BB67196b7CE82AA77230177257,
    ...
    returns (NetworkImplementations memory implementations)
  {
    ...
    if (_chainId == NETWORK_BAKLAVA) {
      implementations = NetworkImplementations({
        ...
        broker: 0x8b0B1e3C4710B2dBa978DcC5D5E9A73302f0C8E0,
        breakerBox: 0x6618A3EBa94A769AA94c4f0d1669dCC5069B0C7D,
        ...
        biPoolManager: 0x52f1e0C70a152d0a6BAB36a0EadBe61E951e0e4B,
