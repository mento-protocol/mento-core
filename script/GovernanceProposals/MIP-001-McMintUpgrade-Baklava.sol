...
// forge script script/GovernanceProposals/MIP-001-McMintUpgrade-Baklava.sol --fork-url http://localhost:8545 --broadcast --legacy --private-key
contract McMintUpgrade is Script, ScriptHelper {
  ...
  function run() public {
    ...
    // TODO: Transfer without prank
    // Transfer ownership of reserve & stable tokens to sender
    // vm.stopPrank();
    // vm.startPrank(proxies.celoGovernance);
